...
app.get("/filter", (req,res) => {
  ...
  const filteredActivities = jokes.filter((joke) => jokes.jokeType === type);
...
app.put("/jokes/:id", (req,res) => {
  ...
  const searchIndex = jokes.find((joke) => jokes.id === id);
...
app.patch("/jokes/:id", (req,res) => {
  ...
  const searchIndex = jokes.find((joke) => jokes.id === joke);
  jokes[searchIndex] = replacementJoke;
  res.json(replacementJoke);
});
